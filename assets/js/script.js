...
function displayTrendCoins(coins) {
    ...
    coinsList.innerHTML = '';
    const table = createTable(['Coin', 'Prix', 'Cap.boursière', 'Volume', '24h%']);
...
function displayTrendNfts(nfts) {
    ...
    nftsList.innerHTML = '';
    const table = createTable(['NFT', 'Marché', 'Prix', 'Volume 24h', '24h%']);
...
function displayAssets(data) {
    ...
    const table = createTable(['Classement', 'Coin', 'Prix', 'Prix 24h', 'Prix 24h %', 'Volume total', 'Cap.boursière', 'Derniers 7 jours'], 1);
...
function displayExchanges(data) {
    ...
    const table = createTable(['Classement', 'Échange', 'Score de confiance', 'Transactions 24h', 'Transactions 24h (Normal)', 'Pays', 'Site Internet', 'Année'], 1);
...
function displayCategories(data) {
    ...
    const table = createTable(['Top Coins', 'Catégorie', 'Cap.boursière', 'Cap.boursière 24h', 'Volume 24h'], 1);
...
function displayCompanies(data) {
    ...
    const table = createTable(['Entreprise', 'Total BTC', 'Valeur d\'entrée', 'Valeur actuelle totale', 'Total %']);
